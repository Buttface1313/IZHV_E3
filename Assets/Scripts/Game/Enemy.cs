...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (nearestPlayer != null)
        {
            ...
            transform.rotation = Quaternion.LookRotation(transform.position-playerPos, Vector3.forward);
            mRigidBody.MovePosition(Vector3.MoveTowards(transform.position, playerPos, speed*Time.fixedDeltaTime));
        }
    }
