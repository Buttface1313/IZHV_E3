...
public class Settings : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerInputManager.instance.onPlayerJoined += (playerInput) => AddPlayer(playerInput.gameObject);
        PlayerInputManager.instance.onPlayerLeft += (playerInput) => RemovePlayer(playerInput.gameObject);
    }
